...
export const mapReelForAdmin = (reel) => ({
  ...
  thumbnailUrl: toAbsoluteUrl(reel?.thumbnailUrl) || '',
  storeName: reel?.storeName || '',
  category: reel?.category || 'All',
  targetApp: reel?.targetApp || 'both',
  ...
  productImageUrl: toAbsoluteUrl(reel?.linkedProduct?.imageUrl) || '',
  likes: reel?.metrics?.likes || 0,
  commentsCount: reel?.metrics?.comments || 0,
